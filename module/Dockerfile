...
WORKDIR /go/src/github.com/PeggyJV/gravity-bridge/module
...
COPY --from=build-env /go/src/github.com/PeggyJV/gravity-bridge/module/build/gravity /usr/bin/gravity

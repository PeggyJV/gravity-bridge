...
func (m *ContractCallTxSignature) GetSignature() string {
	if m != nil {
		return m.Signature
	}
	return ""
...
func (m *BatchTxSignature) GetSignature() string {
	if m != nil {
		return m.Signature
	}
	return ""
...
func (m *SignerSetTxSignature) GetSignature() string {
	if m != nil {
		return m.Signature
	}
	return ""
...
var fileDescriptor_2f8523f2f6feb451 = []byte{
	...
	,
}

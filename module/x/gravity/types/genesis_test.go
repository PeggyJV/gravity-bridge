			...
			DelegateKeys: []*MsgDelegateKeys{
				{
					...
					EVMAddress:          "0xFDb0aaBD40774BBF3068Bf29E8b0a6C88BE26F83",
					EVMSignature:        []byte("0xa2f643b5b919050eb4e200bae900d16fd28adca4d727fb7cc1c68f2517e601d0355340ee0913b1e3b5a5837fbd795857a004e0333913cfb7c59e159ff02115b01c"),
				},
			},
		}, expErr: false},
			...
			DelegateKeys: []*MsgDelegateKeys{
				{
					...
					OrchestratorAddress: "cosmos1h706wwrghfpydyh735aet8aluhf95dqj0psgyf",
					EVMAddress:          "0xFDb0aaBD40774BBF3068Bf29E8b0a6C88BE26F83",
					EVMSignature:        []byte("unused"), // this will marshal into "dW51c2Vk" as []byte will be encoded as base64
				},
			},
		}, expErr: false},

...
var (
	...
	ErrInvalidValidatorAddress          = sdkerrors.Register(ModuleName, 12, "invalid validator address")
	ErrInvalidOrchestratorAddress       = sdkerrors.Register(ModuleName, 13, "invalid orchestrator address")
)

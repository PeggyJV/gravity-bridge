...
type Params struct {
	...
	ParamsByChain    map[string]*ParamsForChain `protobuf:"bytes,2,rep,name=params_by_chain,json=paramsByChain,proto3" json:"params_by_chain,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Params) GetParamsByChain() map[string]*ParamsForChain {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*ParamsForChain)(nil), "gravity.v2.Params.ParamsByChainEntry")
...
var fileDescriptor_b7e9474ccb1d789c = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ParamsByChain == nil {
				m.ParamsByChain = make(map[string]*ParamsForChain)
			}
			var mapkey string

...
mod tests {
    use crate::utils::{
        ...
        message_signatures::{encode_tx_batch_confirm, encode_tx_batch_confirm_hashed},
        types::{Erc20Token, ValsetMember},
        BatchTransaction, TransactionBatch,
    };
    ...
    async fn test_batch_signature() {
        ...
        let erc20_addr = "0x835973768750b3ED2D5c3EF5AdcD5eDb44d12aD4"
            .parse()
            .unwrap();
        let sender_addr: Address = "althea1c8nkaxk3d0p2gd7ummvmyqpdvqd6pkehqhwnnt"
            .parse()
            .unwrap();

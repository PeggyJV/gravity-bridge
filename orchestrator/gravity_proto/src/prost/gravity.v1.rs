...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Msg/CancelSendToEthereum",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn submit_ethereum_tx_confirmation(
            ...
            tonic::Response<super::MsgSubmitEthereumTxConfirmationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn submit_ethereum_event(
            ...
            tonic::Response<super::MsgSubmitEthereumEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Msg/SubmitEthereumEvent",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn set_delegate_keys(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Msg/SetDelegateKeys",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn submit_ethereum_height_vote(
            ...
            tonic::Response<super::MsgEthereumHeightVoteResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Msg/SubmitEthereumHeightVote",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn latest_signer_set_tx(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/LatestSignerSetTx",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn contract_call_tx(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/ContractCallTx",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn contract_call_txs(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/ContractCallTxs",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn signer_set_tx_confirmations(
            ...
            tonic::Response<super::SignerSetTxConfirmationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/SignerSetTxConfirmations",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn batch_tx_confirmations(
            ...
            tonic::Response<super::BatchTxConfirmationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/BatchTxConfirmations",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn contract_call_tx_confirmations(
            ...
            tonic::Response<super::ContractCallTxConfirmationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn unsigned_signer_set_txs(
            ...
            tonic::Response<super::UnsignedSignerSetTxsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/UnsignedSignerSetTxs",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn unsigned_batch_txs(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/UnsignedBatchTxs",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn unsigned_contract_call_txs(
            ...
            tonic::Response<super::UnsignedContractCallTxsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/UnsignedContractCallTxs",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn last_submitted_ethereum_event(
            ...
            tonic::Response<super::LastSubmittedEthereumEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn denom_to_erc20_params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/DenomToERC20Params",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        /// Query for info about denoms tracked by gravity
        ...
        pub async fn batched_send_to_ethereums(
            ...
            tonic::Response<super::BatchedSendToEthereumsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/BatchedSendToEthereums",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn unbatched_send_to_ethereums(
            ...
            tonic::Response<super::UnbatchedSendToEthereumsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/UnbatchedSendToEthereums",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        /// delegate keys
        pub async fn delegate_keys_by_validator(
            ...
            tonic::Response<super::DelegateKeysByValidatorResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gravity.v1.Query/DelegateKeysByValidator",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn delegate_keys_by_ethereum_signer(
            ...
            tonic::Response<super::DelegateKeysByEthereumSignerResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn delegate_keys_by_orchestrator(
            ...
            tonic::Response<super::DelegateKeysByOrchestratorResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn last_observed_ethereum_height(
            ...
            tonic::Response<super::LastObservedEthereumHeightResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()

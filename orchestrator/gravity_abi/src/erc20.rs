...
mod erc20_mod {
    ...
    impl ethers::core::abi::Tokenizable for ERC20Events {
        fn from_token(
        ...
        fn into_token(self) -> ethers::core::abi::Token {
            match self {
                ERC20Events::ApprovalFilter(element) => element.into_token(),
                ERC20Events::TransferFilter(element) => element.into_token(),
            }
        }
    }
    impl ethers::core::abi::TokenizableItem for ERC20Events {}

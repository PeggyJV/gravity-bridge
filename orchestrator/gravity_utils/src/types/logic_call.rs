...
impl LogicCall {
    pub fn from_proto(input: cosmos_gravity_proto::gravity::ContractCallTx) -> Result<Self, GravityError> {
...
impl LogicCallConfirmResponse {
    pub fn from_proto(
        input: cosmos_gravity_proto::gravity::ContractCallTxConfirmation,

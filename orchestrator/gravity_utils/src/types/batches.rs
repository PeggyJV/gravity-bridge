...
impl BatchTransaction {
    pub fn from_proto(input: somm_gravity_proto::gravity::SendToEthereum) -> Result<Self, GravityError> {
...
impl TransactionBatch {
    ...
    pub fn from_proto(input: somm_gravity_proto::gravity::BatchTx) -> Result<Self, GravityError> {
...
impl BatchConfirmResponse {
    pub fn from_proto(
        input: somm_gravity_proto::gravity::BatchTxConfirmation,

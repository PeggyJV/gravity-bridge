...
e2e_evm_upgrade: e2e_clean_slate
	E2E_SKIP_CLEANUP=true integration_tests/integration_tests.test -test.failfast -test.v -test.run UpgradeTestSuite -testify.m TestMultiEVMUpgrade || make -s fail

...
def test_check_validator_signatures_in_isolation(signers):
    ...
    gravity.testCheckValidatorSignatures(getSignerAddresses(validators), powers, sigs, 0x7bc422a00c175cae98cf2f4c36f2f8b63ec51ab8c57fecda9bccf0987ae2d67d, 6666)

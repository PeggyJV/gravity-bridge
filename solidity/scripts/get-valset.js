...
function getValset() {
    return __awaiter(this, void 0, void 0, function () {
        var request_string, response, valsets, valset;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Starting");
                    request_string = args["cosmos-node"] + "/abci_query";
                    return [4 /*yield*/, axios_1["default"].get(request_string, { params: {
                ...
                case 2:
                    ...
                    valset = JSON.parse(decode(valsets.result.response.value));
                    return [2 /*return*/, valset.value];
            }
        });
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getValset()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
